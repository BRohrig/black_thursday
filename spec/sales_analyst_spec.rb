...
RSpec.describe SalesAnalyst do
  ...
  describe '#invoice_total' do
    it 'returns the revenue generated by that invoice' do
      expect(sales_analyst.invoice_total(9)).to eq 0
      expect(sales_analyst.invoice_total(55)).to eq 22338.81
    end
  end

  # describe '#invoice_total' do #MS
  #   s_e = double("sales engine")

  #   allow(s_e).to receive(:transactions).and_return(bunch_of_transaction_data)
  #   expect(sales_analyst.invoice_total(9))
  # end
  ...
  #     allow(s_a).to receive(:invoice_total).and_return(3095.31)
  #     expect(s_a.invoice_total).to eq 3095.31
  #   end
  # end
